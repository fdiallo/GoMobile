...
public class PostList {
	...
	public ArrayList<Post> getPosts(){
		//url_all_posts = "http://10.0.2.2/~faldiall/go-mobile/POSTITPHP/get_all_posts.php";
		//url_all_posts = "http://10.0.2.2/go-mobile/POSTITPHP/get_all_posts.php";
		url_all_posts = "http://www.fallaye.com/get_all_posts.php";
