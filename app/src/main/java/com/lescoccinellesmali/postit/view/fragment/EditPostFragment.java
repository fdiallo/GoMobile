...
import com.lescoccinellesmali.postit.helper.JSONParser;
...
import com.lescoccinellesmali.postit.view.activity.PostUpdatePagerActivity;
...
public class EditPostFragment extends ListFragment {
	...
	private static String url_user_posts = "http://10.0.2.2/~fallaye/PostIt/get_user_posts.php";
	//private static String url_user_posts = "http://lescoccinellesmali.org/get_user_posts.php";
	// private static String url_user_products =
	// "http://lescoccinellesmali.com/get_user_posts.php";
	
	private static String url_delete_post = "http://10.0.2.2/~fallaye/PostIt/delete_post.php";
	//private static String url_delete_post = "http://lescoccinellesmali.org/delete_post.php";
