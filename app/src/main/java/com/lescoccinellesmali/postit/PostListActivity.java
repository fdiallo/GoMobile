...
public class PostListActivity extends SingleFragmentActivity implements TopFragment.TopFragmentListenerInterface  {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mPosts = PostList.get(getApplicationContext()).getPosts();

      /*  for (int i = 0; i < mPosts.size(); i++) {
            Log.i("In PostActivity Title", mPosts.get(i).getTitle());
            Log.i("In PostActivity Author", mPosts.get(i).getAuthor());
            // Log.i("In PostActivity", p.getLocation());
        }*/
	}
